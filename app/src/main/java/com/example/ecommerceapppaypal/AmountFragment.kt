...
class AmountFragment : android.app.DialogFragment() {
    ...
    override fun onCreateView(
        ...
        btnAddToCart.setOnClickListener {
            var ptoURL = "http://192.168.43.104/OnlineEcommerceStorePaypal/insert_temporary_order.php?email=${Person.email}&product_id=${Person.addToCartProductId}&amount=${edtEnterAmount.text.toString()}"
